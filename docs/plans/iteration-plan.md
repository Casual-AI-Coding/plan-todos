...
| 4.4  | 通知 UI 界面 | Settings 页面通知配置 UI            | 待开发     |
| 4.5  | 打卡通知配置 | 打卡提醒策略                        | 待开发     |
...
| 序号 | 功能        | 说明                         | 状态   |
| ---- | ----------- | ---------------------------- | ------ |
| 6.1  | 本地导出    | JSON/SQLite 文件导出         | 待开发 |
| 6.2  | 云同步      | iCloud/Google Drive/OneDrive | 待规划 |
| 6.3  | 冲突解决    | 本地优先/服务端优先/手动合并 | 待规划 |
| 6.4  | WebDAV 支持 | 自托管 NAS 支持              | 待规划 |
