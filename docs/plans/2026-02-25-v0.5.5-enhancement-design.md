...
.card-hover:hover {
  ...
  box-shadow: var(--shadow-md), var(--glass-border-glow);
}
...
describe("CSS Variables", () => {
  ...
  it("should define animation timing variables", () => {
    ...
    expect(styles.getPropertyValue("--animation-easing-spring")).toContain(
      "cubic-bezier",
    );
    expect(styles.getPropertyValue("--animation-duration-normal")).toMatch(
      /\d+ms/,
    );
  });
});
