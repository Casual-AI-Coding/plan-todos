...
const { useGetAll: usePlans, useGetOne: usePlan, useCreate: useCreatePlanBase, useUpdate: useUpdatePlanBase, useDelete: useDeletePlan, useReorder: useReorderPlans } = createEntityHooks<Plan, CreatePlanInput, UpdatePlanInput>({
  entityName: "plans",
  apiGetAll: getPlans,
  apiGetOne: getPlan,
